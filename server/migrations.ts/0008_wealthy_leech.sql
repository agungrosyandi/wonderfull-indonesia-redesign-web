...
--> statement-breakpoint
ALTER TABLE "orderProduct" ADD CONSTRAINT "orderProduct_productVariantID_productVarians_id_fk" FOREIGN KEY ("productVariantID") REFERENCES "public"."productVarians"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
