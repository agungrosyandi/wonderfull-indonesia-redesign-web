...
} from "./navbar-menu-mobile-title";

import { goExplore, plantYourTrip } from "./navbar-menu-mobile-map";
...
export default function NavbarMenuMobile() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full text-white h-screen p-4 uppercase flex flex-col justify-center items-center gap-y-5">
